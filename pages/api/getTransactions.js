export default async function handler(req, res) {
  ...
  const transactionsUrl = `https://store.flow.com/api/loyalty/transaction_entries?limit=100&orderBy=createdAt&websiteId=8f6b91d5-985d-4da7-b253-68681eb4e4f0&walletAddress=${walletAddress}&organizationId=ebc23e35-e19a-4113-8951-dfff40192c5c&excludeDeletedCurrency=true`;
  ...
  try {
    ...
    // Extract balances from accounts data
    const currencyMap = {
